...
export default function WalletTransactionAllHistory() {
  return (
    <>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-5">
            ...
            <section className="flex items-center justify-between">
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-[.1rem]">
                  <h5 className="text-[16px] font-[500]">Fund Deposit</h5>
                  <p className="text-[14px] text-[var(--grey)]">22nd Jan, 2024. 09:00am</p>
                </div>
              </div>

              <div className="">
                <p className="text-[16px] text-[var(--success)]">+ N200,000.24</p>
              </div>
            </section>
            ...
            <section className="flex items-center justify-between">
              ...
              <div className="">
                <p className="text-[16px] text-[var(--danger)]">- N200,000.24</p>
              </div>
            </section>
          </div>
        </div>
