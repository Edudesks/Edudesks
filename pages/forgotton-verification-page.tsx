...
export default function VerifyForgottonPassword() {
  ...
  return (
    <>
      <div
        className={`flex flex-col justify-center lg:flex-row gap-[3.375rem] lg:gap-[4rem] h-screen whitespace-nowrap pb-[4.1875rem] lg:pb-0 lg:overflow-hidden overflow-auto`}
      >
